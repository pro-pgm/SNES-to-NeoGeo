...
Robin Edwards 2018
Adrian Garcia 2020, 6 button mod.
based on the code found at https://github.com/burks10/Arduino-SNES-Controller
*/
// This code modify the orinal code, for use in supergun or DIY supergun, that support 6 buttons, 4 button also support.
// This code has been tested on Arduino Nano.
/* 
...
int output_pins[12] = { PIN_BUT2, PIN_BUT3, PIN_SELECT, PIN_START, PIN_UP, PIN_DOWN, PIN_LEFT, PIN_RIGHT, PIN_BUT1, PIN_BUT4, PIN_BUT5, PIN_BUT6 };
